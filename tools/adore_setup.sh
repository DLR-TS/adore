...
failure(){
    ...
    printf "  The recomended next step is to attempt a manual setup: ${ADORE_HELP_LINK}/mkdocs/getting_started/getting_started/\n"
    printf "\n"
}
...
ADORe will be setup on your system. The following system changes will occurs:
  - Your OS version will be checked against supported Ubuntu versions: ${SUPPORTED_UBUNTU_VERSIONS// /, }
    Note: The only dependencies for ADORe are Docker and GNU Make; however, this automated setup script is supported only on Ubuntu!
          For manual setup please refer to the help getting started help guide: ${ADORE_HELP_LINK}/mkdocs/getting_started/getting_started/
